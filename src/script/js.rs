...
impl JsScript {
    pub fn new() -> Self {
        ...
        eval.call1(
            &JsValue::NULL,
            &JsValue::from_str(include_str!("js_prelude.js")),
        )
        .unwrap();
        Self {
...
impl WheelScript for JsScript {
    fn bind(&mut self, cart: Rc<RefCell<CartContext>>, system: Rc<RefCell<SystemContext>>) {
        ...
        let closure =
            Closure::wrap(
                Box::new(move |x, y, w, h| cart_clone.borrow_mut().clip(x, y, w, h))
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |x, y, r, c: i32| {
            cart_clone
                .borrow_mut()
                .circ(x, y, r, c.try_into().unwrap_or(255))
        }) as Box<dyn FnMut(i32, i32, i32, i32)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let closure = Closure::wrap(Box::new(move |x, y, r, c: i32| {
            cart_clone
                .borrow_mut()
                .circb(x, y, r, c.try_into().unwrap_or(255))
        }) as Box<dyn FnMut(i32, i32, i32, i32)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |x, y, a, b, c: i32| {
            cart_clone
                .borrow_mut()
                .elli(x, y, a, b, c.try_into().unwrap_or(255))
        ...
        let closure = Closure::wrap(Box::new(move |x, y, a, b, c: i32| {
            cart_clone
                .borrow_mut()
                .ellib(x, y, a, b, c.try_into().unwrap_or(255))
        }) as Box<dyn FnMut(i32, i32, i32, i32, i32)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |i, f| cart_clone.borrow().fget(i, f))
        ...
        let closure = Closure::wrap(
            Box::new(move |i, f, v| cart_clone.borrow_mut().fset(i, f, v))
                as Box<dyn FnMut(i32, i32, bool)>,
        );
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(
            Box::new(move || cart_clone.borrow().keyp(None)) as Box<dyn FnMut() -> bool>
        );
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |i: i32| {
            cart_clone.borrow().keyp(Some(i.try_into().unwrap_or(255)))
        }) as Box<dyn FnMut(i32) -> bool>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let closure = Closure::wrap(Box::new(move |i: i32, h, p| {
            cart_clone
                .borrow()
                .keyp_with_hold_period(i.try_into().unwrap_or(255), h, p)
        }) as Box<dyn FnMut(i32, i32, i32) -> bool>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |x1, y1, x2, y2, c: i32| {
            cart_clone
                .borrow_mut()
                .line(x1, y1, x2, y2, c.try_into().unwrap_or(255))
        }) as Box<dyn FnMut(f32, f32, f32, f32, i32)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        Reflect::set(&global, &"line".into(), &func).unwrap();

        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |x, y, w, h, sx, sy, c: i32, s| {
            cart_clone
                .borrow_mut()
                .map(x, y, w, h, sx, sy, c.try_into().unwrap_or(255), s)
        })
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(
            Box::new(move |t, f, l| cart_clone.borrow_mut().memcpy(t, f, l))
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(
            Box::new(move |a, v, l| cart_clone.borrow_mut().memset(a, v, l))
                as Box<dyn FnMut(usize, u8, usize)>,
        );
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure =
            Closure::wrap(Box::new(move |x, y| cart_clone.borrow().mget(x, y))
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(
            Box::new(move |x, y, id| cart_clone.borrow_mut().mset(x, y, id))
                as Box<dyn FnMut(i32, i32, u8)>,
        );
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(
            Box::new(move |a| cart_clone.borrow().peek(a)) as Box<dyn FnMut(usize) -> u8>
        );
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(
            Box::new(move |a, b| cart_clone.borrow().peek_with_bits(a, b))
                as Box<dyn FnMut(usize, usize) -> u8>,
        );
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(
            Box::new(move |a| cart_clone.borrow().peek4(a)) as Box<dyn FnMut(usize) -> u8>
        );
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(
            Box::new(move |a| cart_clone.borrow().peek2(a)) as Box<dyn FnMut(usize) -> u8>
        );
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(
            Box::new(move |a| cart_clone.borrow().peek1(a)) as Box<dyn FnMut(usize) -> u8>
        );
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |x, y| cart_clone.borrow().get_pix(x, y))
            as Box<dyn FnMut(i32, i32) -> u8>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |x, y, c: i32| {
            cart_clone
                .borrow_mut()
                .set_pix(x, y, c.try_into().unwrap_or(255))
        }) as Box<dyn FnMut(i32, i32, i32)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(
            Box::new(move |a| cart_clone.borrow().get_pmem(a)) as Box<dyn FnMut(usize) -> i32>
        );
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |a, v| cart_clone.borrow_mut().set_pmem(a, v))
            as Box<dyn FnMut(usize, i32) -> i32>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure =
            Closure::wrap(Box::new(move |a, v| cart_clone.borrow_mut().poke(a, v))
                as Box<dyn FnMut(usize, u8)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let closure =
            Closure::wrap(
                Box::new(move |a, v, b| cart_clone.borrow_mut().poke_with_bits(a, v, b))
                    as Box<dyn FnMut(usize, u8, usize)>,
            );
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure =
            Closure::wrap(Box::new(move |a, v| cart_clone.borrow_mut().poke4(a, v))
                as Box<dyn FnMut(usize, u8)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure =
            Closure::wrap(Box::new(move |a, v| cart_clone.borrow_mut().poke2(a, v))
                as Box<dyn FnMut(usize, u8)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure =
            Closure::wrap(Box::new(move |a, v| cart_clone.borrow_mut().poke1(a, v))
                as Box<dyn FnMut(usize, u8)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |t: String, x, y, c: i32, f, s, a| {
            cart_clone
                .borrow_mut()
                .print(t.as_str(), x, y, c.try_into().unwrap_or(255), f, s, a)
        })
            as Box<dyn FnMut(String, i32, i32, i32, bool, i32, bool) -> i32>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let closure = Closure::wrap(Box::new(move |t: String, x, y, c: i32, f, s, a| {
            cart_clone
                .borrow_mut()
                .print_ch(t.as_str(), x, y, c.try_into().unwrap_or(255), f, s, a)
        })
            as Box<dyn FnMut(String, i32, i32, i32, bool, i32, bool) -> i32>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |x, y, w, h, c: i32| {
            cart_clone
                .borrow_mut()
                .rect(x, y, w, h, c.try_into().unwrap_or(255))
        }) as Box<dyn FnMut(i32, i32, i32, i32, i32)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let closure = Closure::wrap(Box::new(move |x, y, w, h, c: i32| {
            cart_clone
                .borrow_mut()
                .rectb(x, y, w, h, c.try_into().unwrap_or(255))
        }) as Box<dyn FnMut(i32, i32, i32, i32, i32)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |vec: Vec<i32>| {
            cart_clone.borrow_mut().spr(
                vec[0],
                vec[1],
                vec[2],
                vec[3].try_into().unwrap_or(255),
                vec[4],
                vec[5],
                vec[6],
                vec[7],
        ...
        let closure = Closure::wrap(Box::new(move |vec: Vec<f32>, m, c: i32| {
            cart_clone.borrow_mut().textri(
                ...
                vec[11],
                m,
                c.try_into().unwrap_or(255),
            )
        }) as Box<dyn FnMut(Vec<f32>, bool, i32)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let sys_clone = system.clone();
        let closure =
            Closure::wrap(Box::new(move || sys_clone.borrow().time()) as Box<dyn FnMut() -> u64>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        Reflect::set(&global, &"time".into(), &func).unwrap();

        let sys_clone = system.clone();
        let closure = Closure::wrap(Box::new(move |msg: JsValue, c| {
            sys_clone
                .borrow_mut()
                .trace(msg.as_string().unwrap().as_str(), c);
        }) as Box<dyn FnMut(JsValue, u8)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        Reflect::set(&global, &"trace_2".into(), &func).unwrap();

        let cart_clone = cart.clone();
        let closure = Closure::wrap(Box::new(move |x1, y1, x2, y2, x3, y3, c: i32| {
            cart_clone
                .borrow_mut()
                .tri(x1, y1, x2, y2, x3, y3, c.try_into().unwrap_or(255))
        })
            as Box<dyn FnMut(f32, f32, f32, f32, f32, f32, i32)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let closure = Closure::wrap(Box::new(move |x1, y1, x2, y2, x3, y3, c: i32| {
            cart_clone
                .borrow_mut()
                .trib(x1, y1, x2, y2, x3, y3, c.try_into().unwrap_or(255))
        })
            as Box<dyn FnMut(f32, f32, f32, f32, f32, f32, i32)>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
        ...
        let sys_clone = system.clone();
        let closure =
            Closure::wrap(Box::new(move || sys_clone.borrow().tstamp()) as Box<dyn FnMut() -> u64>);
        let func = closure.as_ref().unchecked_ref::<Function>().clone();
        closure.forget();
    ...
    fn load(&mut self, script: &str) -> Result<(), String> {
        ...
        eval.call1(&JsValue::NULL, &JsValue::from_str(script))
    ...
    fn scanline(&mut self, line: i32) -> Result<(), String> {
        js_sys::eval(&format!(
            "if (typeof scanline !== 'undefined') {{ scanline({}); }}",
            line
        ))
        .map_err(|e| format!("Error calling scanline: {:?}", e))?;
        Ok(())
    }
    fn overlay(&mut self) -> Result<(), String> {
        js_sys::eval("if (typeof overlay !== 'undefined') { overlay(); }")
            .map_err(|e| format!("Error calling overlay: {:?}", e))?;
        Ok(())
    }
